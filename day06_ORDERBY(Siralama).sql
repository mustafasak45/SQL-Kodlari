...
select * from kisiler ORDER BY adres asc; --ASCANDING (ASC) yazmasakta sıralar

-- kisiler tablosunu adres'e göre tersten sıralayarak sorgulayınız.
select * from kisiler order by adres desc;

--Kişiler tablosunda maası buyukten kucuge siralayın
select maas from kisiler order by maas desc;

--İsmi Mine olanları, maas a göre AZALAN sırada sorgulayınız
